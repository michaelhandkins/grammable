...
describe "grams#destroy action" do
  it "should not allow a user who did not create the gram to destroy it" do
  ...
  it "should return a 404 error if the specified gram can't be found" do
    user = FactoryBot.create(:user)
    sign_in user  
...
describe "grams#update action" do
  ...
  it "should return to the edit form with a status of unprocessable_entity if there are validation errors" do
    gram = FactoryBot.create(:gram, message: "Initial Value")
    sign_in gram.user
